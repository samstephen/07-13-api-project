...
CONNECTION.execute("DROP TABLE IF EXISTS types;")
...
CONNECTION.execute("CREATE TABLE IF NOT EXISTS assignments (id INTEGER PRIMARY KEY, description TEXT, repo TEXT);")
...
CONNECTION.execute("CREATE TABLE types (id INTEGER PRIMARY KEY, category TEXT);")
